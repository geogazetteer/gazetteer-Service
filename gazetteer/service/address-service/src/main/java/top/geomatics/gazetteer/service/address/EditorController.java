...
public class EditorController {
	...
	public String editAll(
			...
			@ApiParam(value = "限定查询的记录个数，不指定或指定值为0表示查询所有数据")
	...
	public String editPage(
			@ApiParam(value = "当前页面索引，从1开始")
			@PathVariable(value = "index", required = true) Integer index,
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如油松社区")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
	...
	public String selectByFids(
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如民治街道")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
			@ApiParam(value = "数据库中地址记录的fid，如 1,2,3")
	...
	public String editByCode(
			@ApiParam(value = "指定统一社会信用代码")
			@PathVariable(value = IControllerConstant.ENTERPRISE_CODE, required = true) String code,
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如enterprise1")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
	...
	public String editByName(
			@PathVariable(value = IControllerConstant.ENTERPRISE_NAME, required = true) String name,
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如enterprise1")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
	...
	public String editByOwner(
			@ApiParam(value = "指定法定代表人，如：方海英")
			@PathVariable(value = IControllerConstant.ENTERPRISE_OWNER, required = true) String owner,
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如enterprise1")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
	...
	public String editByAddress(
			@ApiParam(value = "指定JYCS（地址），如：深圳市龙华区龙华街道东环一路天汇大厦B座906室")
	...
	public String editByStatus(
			@ApiParam(value = "指定状态，如0表示未编辑状态，1表示已编辑状态，2表示无法编辑状态")
			@PathVariable(value = IControllerConstant.ENTERPRISE_STATUS, required = true) int status,
			@ApiParam(value = "查询字段，如 fid,code,name,address")
			@RequestParam(value = IControllerConstant.TABLE_FIELDS, required = false, defaultValue = "*") String fields,
			@ApiParam(value = "查询的数据库表，如enterprise1")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
	...
	public String updateAll(
			@ApiParam(value = "查询的数据库表，如福民社区")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
			@ApiParam(value = "更新后的状态")
	...
	public String updateStatus(
			@ApiParam(value = "更新后的状态，如：0（表示未修改），1（表示已修改），2（表示无法修改）")
			@PathVariable(value = IControllerConstant.ENTERPRISE_STATUS_NEW, required = true) Integer new_status,
			@ApiParam(value = "查询的数据库表，如福民社区")
			@RequestParam(value = IControllerConstant.TABLE_NAME, required = false, defaultValue = IControllerConstant.ENTERPRISE_TABLE_NAME) String tablename,
			@ApiParam(value = "条件：指定地址记录的fid")
			@RequestParam(value = IControllerConstant.ENTERPRISE_DB_ID, required = false) Integer fid,
			@ApiParam(value = "条件：指定统一社会信用代码，如：91440300342919578H")
			@RequestParam(value = IControllerConstant.ENTERPRISE_CODE, required = false, defaultValue = "") String code,
			@ApiParam(value = "条件：指定企业名称")
			@RequestParam(value = IControllerConstant.ENTERPRISE_NAME, required = false, defaultValue = "") String name,
			@ApiParam(value = "条件：指定所在街道")
	...
	public String updateDate(
			@ApiParam(value = "更新后的编辑日期，如：20190327")
	...
	public String updateAddress(
			@ApiParam(value = "更新后的标准地址，如：广东省深圳市龙华区福城街道福民社区冼屋居民小组厂房一116号")
	...
	public String updateAddressId(
			@ApiParam(value = "更新后的标准地址编码，如：63EEDE6BA0046A3AE0538CC0C0C07BB0")
